...
namespace FamilyGameNight.Migrations
{
    ...
    [Migration("20230426034936_PlayerTableRestructure")]
    partial class PlayerTableRestructure
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FamilyGameNight.Models.Players", b =>
                {
                    ...
                    b.HasIndex(new[] { "UserId", "Lobby" }, "UserID_Lobby")
                        .IsUnique();
            ...
            modelBuilder.Entity("FamilyGameNight.Models.User", b =>
                {
                    ...
                    b.HasIndex(new[] { "FirebaseId" }, "UserFirebaseIdUniqueConstraint")
                        .IsUnique();
