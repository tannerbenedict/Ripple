...
import 'package:ripple/ui/games/gin_rummy/top_section.dart';
import 'package:ripple/ui/games/gin_rummy/bottom_section.dart';
import 'package:ripple/ui/games/gin_rummy/game_over.dart';
...
class GinRummy extends HookConsumerWidget {
  static const soloRouteName = "ginRummySolo";
  static const onlineRouteName = "ginRummyOnline";
  ...
  void _showWinnerBox(BuildContext context, WidgetRef ref) async {
    ...
    if (user != null) {
      await ref
          ...
          .winGin(User.fromFirebaseUser(user));
  ...
  void _showLoserBox(BuildContext context, WidgetRef ref) async {
    ...
    if (user != null) {
      await ref
          .read(databaseRepositoryProvider)
          .loseGin(User.fromFirebaseUser(user));
    }
