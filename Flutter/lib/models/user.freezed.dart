...
mixin _$User {
  ...
  List<String> get cardBacks => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      coins: null == coins
          ...
          : coins // ignore: cast_nullable_to_non_nullable
              as int,
      cardBacks: null == cardBacks
          ? _value.cardBacks
          : cardBacks // ignore: cast_nullable_to_non_nullable
              as List<String>,
      selectedCardBack: null == selectedCardBack
          ? _value.selectedCardBack
          : selectedCardBack // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$UserImpl extends _User {
  _$UserImpl(
      ...
      this.profileUrl,
      required this.coins,
      required final List<String> cardBacks,
  ...
  @override
  final int coins;
  final List<String> _cardBacks;
  @override
  List<String> get cardBacks {
    if (_cardBacks is EqualUnmodifiableListView) return _cardBacks;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_cardBacks);
  }
